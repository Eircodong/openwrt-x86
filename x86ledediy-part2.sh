...
#删除重复插件
rm -rf feeds/smpackage/{adguardhome,base-files,dnsmasq,firewall*,fullconenat,libnftnl,linkmount,nftables,ppp,opkg,ucl,upx,vsftpd*,miniupnpd-iptables,wireless-regdb,luci-app-argone-configluci-theme-argon,luci-theme-argone,luci-app-adguardhome}
